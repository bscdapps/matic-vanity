<template>
    <div class="panel">
        <p>
            Vanity-BSC is an open source tool using your web browser to generate Binance vanity addresses.<br>
        ...
        <p>
            ...
            <b>Vanity-BSC cannot and will never store your private key</b>, and if you don't trust it, you have 3 ways to ensure
            ...
            &nbsp;-&nbsp;You can also download the latest build of Vanity-BSC
            ...
            <br>
            Vanity-BSC uses a cryptographically secure pseudorandom number generator (CSPRNG) to generate
            Binance addresses.<br>
        ...
        <h2>Performance</h2>
        <p>
            For some reason, the performance of Vanity-BSC can vary a lot from a browser to another.
        ...
        <h2>Compatibility</h2>
        <p>
            Any address generated with Vanity-BSC is ERC-20 compatible, which means you can use it for an ICO, an
